00001 PRINT "(C) 1977-2014 Richard Garriott"
00002 PRINT "Ported by Data Net Drienerlo"
00010 LET J4=1
00030 PRINT
00100 BASE 0
00110 LET X=0
...
01410 RESTORE #D
01415 PRINT "READING DUNGEON NUM.  ";
01416 PRINT D
01420 FOR M=0 TO 25
01430 FOR N=0 TO 25
01431 D(M,N)=0
...
01490 PRINT
01500 PRINT
01510 PRINT "WELCOME TO DUNGEON #";
01511 PRINT D
...
02070 NEXT M
02080 READ #7,X3
02081 IF X3=0 THEN 02120
02090 FOR M=1 TO X3
02100 READ #7,X4(M)
02110 NEXT M
02120 READ #7,X1
02125 IF X1=0 THEN 02151
02130 FOR M=1 TO X1
02140 READ #7,X2(M)
02150 NEXT M
02151 READ #7,F2
...
02720 NEXT M
02730 GOTO 02890
02740 PRINT "NO SPIKES AH THATS TOO BAD BECAUSE YOUR DEAD "
02750 STOP
...
03000 GOTO 02480
03010 PRINT "YOU UST RAN INTO A SECRET DOOR"
...
03290 LET S=1
03300 LET T=0
03310 IF D(G+S,T+T)=4 THEN 03350
...
04530 FOR M=-1 TO 1
04540 FOR N=-1 TO 1
04550 IF D(G+M,H+N)=4 THEN 04610
04560 NEXT N
04570 NEXT M
...
06485 IF D(M+G,N+H)=7 OR D(G+M,H+N)=8 THEN 06550
...
06900 NEXT M
06910 WRITE #7,X3
06915 IF X3=0 THEN 06950
06920 FOR M=1 TO X3
06930 WRITE #7,X4(M)
06940 NEXT M
06950 WRITE #7,X1
06955 IF X1=0 THEN 06972
06960 FOR M=1 TO X1
06970 WRITE #7,X2(M)
06971 NEXT M
06972 WRITE #7,F2
...
08355 IF J6=1 THEN 08370
08360 LET B(K,5)=0
08370 PRINT "YOU HAVE";C(7);" GOLD "
08380 LET B(K,6)=0
08381 IF J6<>1 THEN 08390
...
08480 IF D(G+M,H+N)=5 THEN 08250
08490 NEXT N
08500 NEXT M
08510 LET R1=1000
08520 LET R8=M
